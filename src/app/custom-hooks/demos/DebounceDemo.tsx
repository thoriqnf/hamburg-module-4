  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        • Reduces API calls from 100+ to 1-2 per search<br/>
        • Prevents server overload from rapid typing<br/>
        • Better UX with less unnecessary loading<br/>
        • Saves bandwidth and processing power<br/>
        • Essential for search, autocomplete, filters
      </div>
    </div>
  );
}