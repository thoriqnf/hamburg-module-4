...
export default function ToggleDemo() {
  ...
  const [darkMode, toggleDarkMode, setDarkModeTrue, setDarkModeFalse] = useToggle(false);
  ...
  return (
    <div style={{
      ...
      <p style={{ color: darkMode ? '#ccc' : '#666', fontSize: '14px', marginBottom: '20px' }}>
      ...
      <div style={{
        ...
        • Cleaner than useState(false)<br/>
        • Built-in toggle function<br/>
        • Optional setTrue/setFalse helpers<br/>
        • Perfect for modals, dropdowns, themes<br/>
