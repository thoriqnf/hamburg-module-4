...
export default function CartDemo() {
  const [items, setItems] = useState([
    ...
    { id: 3, name: 'Orange', price: 1.50, quantity: 2 }
  ]);
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '500px', margin: '0 auto' }}>
      ...
      <p style={{ color: '#666', fontSize: '14px', marginBottom: '20px' }}>
        Efficient cart calculations using useMemo to prevent unnecessary recalculations.
      </p>
      ...
      <div style={{
        ...
        • useMemo prevents recalculating on every render<br/>
        • Only recalculates when items array changes<br/>
        • 60-80% performance improvement for large carts<br/>
        • Essential for e-commerce applications<br/>
