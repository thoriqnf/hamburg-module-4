  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        • Track changes without extra re-renders<br/>
        • Compare current vs previous values<br/>
        • Trigger actions only on value changes<br/>
        • Useful for animations, validations<br/>
        • Lightweight - just uses useRef
      </div>
    </div>
  );
}